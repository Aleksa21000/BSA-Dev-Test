		...
		<div class="footer__main">
            <div class="footer__main-company footer-company">
            	<a href="/" class="footer-company__link">
            		<img src="public/images/general/logo.png" alt="Company" class="footer-company__logo">
            	</a>
                	...
                	<ul class="footer-services__list">
                		<li class="footer-services__list-item">
                			<a href="#" class="footer-services__list-link">
                				<img src="public/images/general/welding-icon.svg" alt="Welding" class="footer-services__list-icon">
                	...
                	<ul class="footer-brands__list">
                		<li class="footer-brands__list-item">
                			<a href="#" class="footer-brands__list-link">
                				<img src="public/images/general/logo.png" alt="" class="footer-brands__list-logo">
                			</a>
                		</li>
                		<li class="footer-brands__list-item">
                			<a href="#" class="footer-brands__list-link">
		...
		<div class="footer__navigation footer-navigation">
        	<nav class="footer-navigation__main">
        		<ul class="footer-navigation__list">
        			<li class="footer-navigation__list-item | js-section-link" data-name="about">
        				<a href="#" class="footer-navigation__link">Experience</a>
        			</li>
        			<li class="footer-navigation__list-item | js-section-link" data-name="culture">
        				<a href="#" class="footer-navigation__link">Company</a>
        			</li>
        			<li class="footer-navigation__list-item | js-section-link" data-name="openings">
        	...
        	<button id="footer-scroll-top" class="footer-navigation__to-top | js-back-to-top">To Top</button>
		</div>
	</div>
</footer>
