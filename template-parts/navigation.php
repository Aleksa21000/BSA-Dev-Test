        ...
        <div class="navigation__header navigation-header">
        	<div id="navigation-header" class="navigation-header__company">
    			<a href="/" class="navigation-header__company-link">
    				<img src="public/images/general/logo.png" alt="Company Logo" class="navigation-header__company-logo">
    			</a>
			...
			<div class="navigation__main-inner">
                <nav id="navigation-menu" class="navigation__menu navigation-menu">
                	<ul class="navigation-menu__list">
                			...
                			<ul class="navigation-menu__submenu">
                				<li class="navigation-menu__submenu-item">
                					<a href="#" class="navigation-menu__submenu-link">
                						<img src="public/images/general/welding-icon.svg" alt=""  class="navigation-menu__submenu-icon">
                		...
                		<li class="navigation-menu__item | js-section-link" data-name="about">
                			<a href="#" class="navigation-menu__link">
                				<span class="navigation-menu__indicator">02</span>
                				<span class="navigation-menu__label">Experience</span>
                			</a>
                		</li>
                		<li class="navigation-menu__item | js-section-link" data-name="culture">
                			<a href="#" class="navigation-menu__link">
                				<span class="navigation-menu__indicator">03</span>
                				<span class="navigation-menu__label">Company</span>
                			</a>
                		</li>
                		<li class="navigation-menu__item | js-section-link" data-name="openings">
                			<a href="#" class="navigation-menu__link">
