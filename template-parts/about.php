<section id="about" class="about | js-section">
	...
	<div class="about__content about-content">
		<picture class="about-content__picture">
			<img src="public/images/about/main.jpg" alt="" class="about-content__image">
		</picture>
	...
	<div class="about__cards about-cards">
        <article class="card-item">
        	<div class="card-item__decoration card-item-decoration" aria-hidden="true">
        		<span class="card-item-decoration__text">001</span>
        	</div>
        	<img src="public/images/about/icon.svg" alt="" class="card-item__icon">
        ...
        <article class="card-item">
        	<div class="card-item__decoration card-item-decoration" aria-hidden="true">
        		<span class="card-item-decoration__text">002</span>
        	</div>
        	<img src="public/images/about/icon.svg" alt="" class="card-item__icon">
        	<h3 class="card-item__title">Safety</h3>
        	<p class="card-item__content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        ...
        <article class="card-item">
        	<div class="card-item__decoration card-item-decoration" aria-hidden="true">
        		<span class="card-item-decoration__text">003</span>
        	</div>
        	<img src="public/images/about/icon.svg" alt="" class="card-item__icon">
        	<h3 class="card-item__title">Safety</h3>
        	<p class="card-item__content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        ...
        <article class="card-item">
        	<div class="card-item__decoration card-item-decoration" aria-hidden="true">
        		<span class="card-item-decoration__text">004</span>
        	</div>
        	<img src="public/images/about/icon.svg" alt="" class="card-item__icon">
        	<h3 class="card-item__title">Safety</h3>
        	<p class="card-item__content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
		...
		<article class="card-item">
        	<div class="card-item__decoration card-item-decoration" aria-hidden="true">
        		<span class="card-item-decoration__text">005</span>
        	</div>
        	<img src="public/images/about/icon.svg" alt="" class="card-item__icon">
        	<h3 class="card-item__title">Safety</h3>
        	<p class="card-item__content">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
