<section id="hero" class="hero | js-parallax-container">
		...
		<div class="hero__media | js-parallax">
			<div class="hero__media-main">
				<picture class="hero__picture hero__picture-main">
					<img src="public/images/hero/main.jpg" alt="" class="hero__image">
				</picture>
			</div>
			<picture class="hero__picture hero__picture-top">
				<img src="public/images/hero/top.jpg" alt="" data-movement="150" class="hero__image | js-parallax-item">
			</picture>
			<picture class="hero__picture hero__picture-bottom">
				<img src="public/images/hero/bottom.jpg" alt="" data-movement="300" class="hero__image | js-parallax-item">
			</picture>
		</div>
